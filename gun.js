...
export function createGun(scene, camera) {
    ...
    const gunTexture = textureLoader.load('public/images/corrugated_iron_03_diff_4k.jpg');
    const handletexture = textureLoader.load('public/images/wooden_gate_diff_4k.jpg');
